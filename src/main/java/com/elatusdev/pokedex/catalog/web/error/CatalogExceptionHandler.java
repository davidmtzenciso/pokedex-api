package com.elatusdev.pokedex.catalog.web.error;

import com.elatusdev.pokedex.shared.domain.exception.InvalidPaginationException;
...
import com.elatusdev.pokedex.web.dto.FieldErrorDTO;
...
// WU-US04-B folds these rows into the full GlobalExceptionHandler.
